...
public class NestDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, NestDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDtoAccess().getGroup_3(), "rule__Dto__Group_3__0");
			...
			builder.put(grammarAccess.getRequiredOptionAccess().getGroup(), "rule__RequiredOption__Group__0");
			...
			builder.put(grammarAccess.getEntityAccess().getMethodsAssignment_6(), "rule__Entity__MethodsAssignment_6");
			builder.put(grammarAccess.getDtoAccess().getDescriptionAssignment_0(), "rule__Dto__DescriptionAssignment_0");
			builder.put(grammarAccess.getDtoAccess().getNameAssignment_2(), "rule__Dto__NameAssignment_2");
			builder.put(grammarAccess.getDtoAccess().getSuperTypeAssignment_3_1(), "rule__Dto__SuperTypeAssignment_3_1");
			builder.put(grammarAccess.getDtoAccess().getPropertiesAssignment_5(), "rule__Dto__PropertiesAssignment_5");
			...
			builder.put(grammarAccess.getPropertyAccess().getPropertyOptionsAssignment_6_1(), "rule__Property__PropertyOptionsAssignment_6_1");
