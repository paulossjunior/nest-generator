...
public class NestDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MultipleArgumentRelationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSecondArgumentSECONDARGUMENTTerminalRuleCall_3_0 = (RuleCall)cSecondArgumentAssignment_3.eContents().get(0);
		
		//MultipleArgumentRelation:
		//	argument=('ManyToOne' | 'OneToMany') type=[Entity] ',' secondArgument=SECONDARGUMENT;
		@Override public ParserRule getRule() { return rule; }
		...
		//SECONDARGUMENT
		public RuleCall getSecondArgumentSECONDARGUMENTTerminalRuleCall_3_0() { return cSecondArgumentSECONDARGUMENTTerminalRuleCall_3_0; }
	}
	...
	private final TerminalRule tSECONDARGUMENT;
	...
	public NestDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tSECONDARGUMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "prodest.es.gov.br.dsl.NestDsl.SECONDARGUMENT");
	}
	...
	//terminal SECONDARGUMENT:
	//	('a'..'z' | 'A'..'Z' | '_') ('a'..'z' | 'A'..'Z' | '_' | '0'..'9')* '.' ('a'..'z' | 'A'..'Z' | '_') ('a'..'z' |
	//	'A'..'Z' | '_' | '0'..'9')*;
	public TerminalRule getSECONDARGUMENTRule() {
		return tSECONDARGUMENT;
	}
