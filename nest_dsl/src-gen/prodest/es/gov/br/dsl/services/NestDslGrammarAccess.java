...
public class NestDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DescriptionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prodest.es.gov.br.dsl.NestDsl.Description");
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		...
		//Entity:
		//	description=Description? 'entity' name=ID ('extends' superType=[Entity|QualifiedName])? '{' properties+=Property*
		//	methods+=Method* '}';
		@Override public ParserRule getRule() { return rule; }
	...
	public class DtoElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cExtendsKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Assignment cSuperTypeAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final CrossReference cSuperTypeDtoCrossReference_3_1_0 = (CrossReference)cSuperTypeAssignment_3_1.eContents().get(0);
		private final RuleCall cSuperTypeDtoQualifiedNameParserRuleCall_3_1_0_1 = (RuleCall)cSuperTypeDtoCrossReference_3_1_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cPropertiesAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cPropertiesDtoPropertyParserRuleCall_5_0 = (RuleCall)cPropertiesAssignment_5.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_6 = (Keyword)cGroup.eContents().get(6);
		
		//Dto:
		//	description=Description? 'dto' name=ID ('extends' superType=[Dto|QualifiedName])? '{' properties+=DtoProperty* '}';
		@Override public ParserRule getRule() { return rule; }
		...
		//[Dto|QualifiedName]
		public CrossReference getSuperTypeDtoCrossReference_3_1_0() { return cSuperTypeDtoCrossReference_3_1_0; }
		
		//QualifiedName
		public RuleCall getSuperTypeDtoQualifiedNameParserRuleCall_3_1_0_1() { return cSuperTypeDtoQualifiedNameParserRuleCall_3_1_0_1; }
		...
		//DtoProperty
		public RuleCall getPropertiesDtoPropertyParserRuleCall_5_0() { return cPropertiesDtoPropertyParserRuleCall_5_0; }
	...
	public class PropertyElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cPropertyOptionsAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cPropertyOptionsPropertyOptionsParserRuleCall_6_1_0 = (RuleCall)cPropertyOptionsAssignment_6_1.eContents().get(0);
		...
		//propertyOptions=PropertyOptions
		public Assignment getPropertyOptionsAssignment_6_1() { return cPropertyOptionsAssignment_6_1; }
		
		//PropertyOptions
		public RuleCall getPropertyOptionsPropertyOptionsParserRuleCall_6_1_0() { return cPropertyOptionsPropertyOptionsParserRuleCall_6_1_0; }
	...
	public class PropertyOptionsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prodest.es.gov.br.dsl.NestDsl.PropertyOptions");
		private final RuleCall cRequiredOptionParserRuleCall = (RuleCall)rule.eContents().get(1);
		
		//PropertyOptions:
		//	RequiredOption /*Modular, dessa forma uma property Option pode ser adicionada com mais facilidade no futuro */;
		@Override public ParserRule getRule() { return rule; }
		
		//RequiredOption
		public RuleCall getRequiredOptionParserRuleCall() { return cRequiredOptionParserRuleCall; }
	}
	public class RequiredOptionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "prodest.es.gov.br.dsl.NestDsl.RequiredOption");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRequiredKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final RuleCall cBOOLEANTYTPETerminalRuleCall_2 = (RuleCall)cGroup.eContents().get(2);
		...
		//BOOLEANTYTPE
		public RuleCall getBOOLEANTYTPETerminalRuleCall_2() { return cBOOLEANTYTPETerminalRuleCall_2; }
	}
	...
	private final PropertyOptionsElements pPropertyOptions;
	private final RequiredOptionElements pRequiredOption;
	private final TerminalRule tBOOLEANTYTPE;
	...
	public NestDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pPropertyOptions = new PropertyOptionsElements();
		this.pRequiredOption = new RequiredOptionElements();
		this.tBOOLEANTYTPE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "prodest.es.gov.br.dsl.NestDsl.BOOLEANTYTPE");
	...
	//PropertyOptions:
	//	RequiredOption /*Modular, dessa forma uma property Option pode ser adicionada com mais facilidade no futuro */;
	public PropertyOptionsElements getPropertyOptionsAccess() {
		return pPropertyOptions;
	}
	
	public ParserRule getPropertyOptionsRule() {
		return getPropertyOptionsAccess().getRule();
	}
	
	//RequiredOption:
	//	'required' ':' BOOLEANTYTPE;
	public RequiredOptionElements getRequiredOptionAccess() {
		return pRequiredOption;
	}
	
	public ParserRule getRequiredOptionRule() {
		return getRequiredOptionAccess().getRule();
	}
	
	//terminal BOOLEANTYTPE:
	//	'true' | 'false';
	public TerminalRule getBOOLEANTYTPERule() {
		return tBOOLEANTYTPE;
	}
